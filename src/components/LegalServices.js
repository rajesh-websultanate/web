...
export default function LegalServices() {
    return (
        <div className="py-5 sm:py-10 lg:pt-12 lg:pb-16">
            <div className="text-lg sm:text-2xl md:text-3xl lg:heading text-center mb-5 sm:mb-10 lg:mb-20 font-bold">LegelServices</div>
            <div className="container mx-auto px-5">
                <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-10 xl:gap-0">
                    <div className="group">
                        <div className="p-5 sm:p-10 box-legal duration-200 h-full">
                            <img src={Legal01} alt="" className="img-responsive mb-9" />
                            <div className="text-lg md:h4 mb-4 font-bold">Estate Planning</div>
                            <p className="mb-8 md:max-w-xs">Our team of experts can guide and advise you on international planning offering you the best options</p>
                    ...
                    <div className="group">
                        <div className="p-5 sm:p-10 box-legal duration-200">
                            <img src={Legal02} alt="" className="img-responsive mb-9" />
                            <div className="text-lg md:h4 mb-4 font-bold">Real State</div>
                            <p className="mb-8 md:max-w-xs">We will enable all the proceedings
                    ...
                    <div className="group">
                        <div className="p-5 sm:p-10 box-legal duration-200">
                            ...
                            <p className="mb-8 md:max-w-xs">We provide counseling on the most suitable coverage for the client’s needs related to immigration</p>
                            <Link to="/" className="group-hover:text-primary font-bold flex items-center justify-end">
                                <span className="ml-3 group-hover:opacity-100 opacity-0 duration-200">VIEW WHAT WE PROVIDE</span>
                                <img src={legalarrow01} alt="" className="h-4 group-hover:opacity-0 duration-200 ml-3" />
                                <img src={legalarrow02} alt="" className="h-4 group-hover:opacity-100 opacity-0 duration-200" />
