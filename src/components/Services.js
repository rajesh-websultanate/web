...
export default function Services() {
    return (
        <div className="lg:container-full mx-auto px-4 sm:px-10 md:px-16 md:my-32">
            <p className="text-2xl lg:heading mb-0 sm:mb-10 xl:mb-16 md:text-center font-bold md:mb-16 mb-11">Genealogy Services</p>
            <div className="lg:pl-24 pb-20 section shadow-md lg:pb-14 md:flex">
                <div className="bg-light-gray md:w-33rem pt-14 pb-14 md:py-20">
                ...
                <div className="px-5 md:pl-32 md:pr-24">
                    <ul className="list-none unorder-list mt-14 mb-9 md:my-20">
