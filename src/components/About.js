...
export default function About() {
    return (
        <div className="bg-gray lg:bg-transparent">
            <div className="container-full mx-auto px-4 xl:px-4-3 pb-14 lg:pb-0 xl:pb-24">
                <div className="section">
                    <div className="grid lg:grid-cols-2 gap-0 about-shadow">
                        <div className="px-5 xl:pl-24 lg:pl-14 lg:mt-14 lg:pr-10.5 mt-11 sm:mt-14 xl:mt-40">
                        ...
                        <div className="flex px-5 lg:px-0 justify-center xl:justify-end mt-8 mb-14 sm:my-16">
