...
export default function About() {
    return (
        <div className="bg-gray lg:bg-transparent pb-3-7 xl:pb-0">
            <div className="container-full mx-auto px-4 xl:pr-0 xl:pl-4-3 lg:pb-0">
                    ...
                    <div className="grid lg:grid-cols-2 gap-0 about-shadow">
                        <div className="px-5 xl:pl-28 lg:pl-14 lg:mt-14 lg:pr-10.5 mt-11 sm:mt-14 xl:mt-40">
                            ...
                            <div className="md:pr-24">
                                ...
                                <p className="mb-9 xl:mb-4-5">We operate in Venezuela, Colombia, the United States, Mexico, Spain, Italy and Portugal.</p>
                            </div>
                            <button className="btn-primary mx-0 sm:mb-6 md:mb-0 mb-8">FIND OUT MORE</button>
                        </div>
                        <div className="flex px-5 lg:px-0 justify-center xl:justify-end md:pt-4-3 md:pb-4-3 pb-3-6">
